...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if  (empty($errors)) {
        ...
        if (!$patient_id) {
            ...
            $stmt->execute([$first_name,$last_name,$email,$phone,$date_of_birth,$gender]);
        ...
        setFlashMessage('success','Thank you! Your appointment request submitted successfully. We will call you once it is approved.');
...
$doctors = $pdo->query("SELECT id, CONCAT(first_name,' ',last_name,' (',specialization,')') AS name FROM doctors
...
<h1 style="text-align: center; margin: 20px; padding-butto : 7px;">Book an Appointment</h1>
<?php
